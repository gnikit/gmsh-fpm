...
!
! This file defines the Gmsh Fortran API (v4.14.0).
!
...
module gmsh
  ...
  integer, parameter, public :: GMSH_API_VERSION_MINOR = 14
  ...
  character(len=100), parameter, public :: GMSH_API_VERSION = "4.14.0"
